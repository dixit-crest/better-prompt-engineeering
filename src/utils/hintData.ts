...
export const HINT_DATA: Record<string, Hint> = {
  ...
  userStories: {
    description: "Define features using the 'As a [user], I want to [action], so that [benefit]' format.",
    placeholder: "e.g., As a customer, I want to see my order history so I can track my spending...",
    examples: [
  ...
  behaviorSpecifications: {
    ...
    placeholder: "e.g., If the user is logged in, show the profile page; otherwise, redirect to login...",
    examples: [
