...
**AI agents:** Also read [AGENTS.md](./AGENTS.md) and the standards in [docs/](./docs/README.md). Never guess branch names, commit format, DoD, or test requirements.
...
- **Run Development Server**: `npm run dev` (port 9000)
- **Build Project**: `npm run build`
- **Lint Code**: `npm run lint`
- **Run Tests**: `npm test`
- **Watch Tests**: `npm run test:watch`
- **Test Coverage**: `npm run test:coverage`
- **Pre-PR Gate**: `./scripts/verify-local.sh`

## Architecture

The application follows a component-based architecture with a clear separation between UI and business logic. See [ARCHITECTURE.md](./ARCHITECTURE.md) for full system design.
...
- **Modular Prompt Assembly**: The final prompt is constructed by iterating through enabled sections in a predefined priority order (`src/utils/assemblePrompt.ts`).
